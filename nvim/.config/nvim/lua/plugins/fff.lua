return {
    ...
    config = function()
        require("fff").setup({
            ...
            layout = {
                width = 0.80,          -- Window width as fraction of screen
    ...
    keys = {
        {"<leader>pf", function() require("fff").find_files() end, desc = "Find files in current directory",},
        {"<leader>pgf", function() require("fff").find_in_git_root() end, desc = "Find files in git root",},
        {"<leader>ps", function() require('fff').live_grep({ grep = { modes = { 'fuzzy', 'plain' } } }) end, desc = 'Live grep word',},
        {"<leader>pws", function() require('fff').live_grep_under_cursor({ grep = { modes = { 'fuzzy', 'plain' } } }) end, mode = { 'n', 'x' }, desc = 'Live grep word',},
        {"<leader>pcf", function() require("fff").find_files_in_dir("~/dotfiles/nvim/.config/nvim") end, desc = "Find files in specified path",},
    },
}
